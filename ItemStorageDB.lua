ItemStorageDB_LastUpdate = 1772986746
ItemStorageDB = {
	{
		name = "Извечка",
		updated_at = "2026-03-08 18:19:06",
		money = 9680,
		empty = 83,
		location = "Оргриммар",
		items = {
			...
			},
			{
				...
				name = "Черный купорос",
				count = 75,
				details = { quality = 1, type = "Хозяйственные товары", subtype = "Другое" },
			},
			{
			...
			},
			{
				...
				name = "Слеза Сирены",
				count = 18,
				details = { quality = 3, type = "Самоцветы", subtype = "Простые" },
			},
		},
	},
	{
